;(function() {
  ...
  function select_element(index) {
    ...
    element.innerHTML = '<div id="result-pointer" style="position:absolute;left:-25px;top:5px;width:20px;color:white;z-index:1000;font-size:20px;height:20px;background-color:green;text-align:center;line-height:20px;border-radius:3px;">&gt;</div>' + element.innerHTML
    // 3.
