...
watermark2000_path = 'images/test_watermark-2000.png'
...
output_i800w2000c_path = 'images/temp_i800w2000c'
output_i320w2000c_path = 'images/temp_i320w2000c'
...
puts 'Test i800w2000c'.green
image = Watermarkize::Image.open image800_path
image.mark watermark2000_path, dx: 60, dy: 60, repeat: false
image.save output_i800w2000c_path

puts 'Test i320w2000c'.green
image = Watermarkize::Image.open image320_path
image.mark watermark2000_path, dx: 60, dy: 60, repeat: false
image.save output_i320w2000c_path
