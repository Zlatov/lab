...
puts 'Массив хэшей|Хэш хэшей - выбрать только те элементы значения которых равны заданному (.select, .select!)'.green
...
puts 'Перебор .each по несколько элементов (.each_slice)'.green
a = (1..5)
...
puts 'Перебор .each по несколько элементов и индекс (.each_slice.with_index)'.green
a = (1..5)
