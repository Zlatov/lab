...
puts 'Если шаблон НЕ СОДЕРЖИТ групп - возвращает массив совпадений'.blue
a = 'жестокий мир'
b = a.scan(/фыв/)
print 'b: '.red; p b
puts 'Если шаблон СОДЕРЖИТ группы   - возвращает массив в котором каждый элемент - массив по одному совпадению на группу'.blue
a = 'жестокий мир'
b = a.scan(/(..)(.)/)
print 'b: '.red; p b
a = 'жесто 000012345 кий мир'
b = a.scan(/(?<![0-9]{1})[0-9]{9}(?![0-9]{1})/)
print 'b: '.red; p b
# exit
