...
du -h -d 1 | sort -h  # размеры каталогов на глубину 1 с сортировкой.
...
pwd -P # Реальный путь (учитывая ссылки)
df -h . # Определяет на каком диске расположен текущий каталог
```
