...
class User
  has_many :orders,
    inverse_of: :user # При создании нестандартных названий (таблиц моделей)/связей необходимо помогать рельсе распознавать двунаправленную связь.
...
# :validate -
# :autosave -
# :inverse_of - При создании нестандартных названий (таблиц моделей)/связей необходимо помогать рельсе распознавать двунаправленную связь.
# :extend -
# 
